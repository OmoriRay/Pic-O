...
internal static class Program
{
    ...
    private static string FindRepositoryRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "PureView.sln")))
            {
        ...
        throw new DirectoryNotFoundException("Could not find PureView.sln.");
    }
